...
<body>
    <!-- Navbar -->
    <nav>
        <div class="logo"><a ="index.php">CUNA'S BAKERY</a></div>
        <ul class="links">
            <li><a ="index.php">HOME</a></li>
            <li><a ="items.php">ITEMS</a></li>
        </ul>
        <div class="btns">
            <a ="product.php" class="order-now-btn">ORDER NOW</a>
            <a ="cart.php" class="cart-btn"><span class="material-symbols-outlined">shopping_cart</span></a>
        </div>
    </nav>
    <main>
        <!-- Item Display -->
